...
from palu.rank_search_fisher_aware import rank_search
from tqdm import tqdm
# from palu.decomposition_double_svd import compress_model
from palu.decomposition_fisher_aware import compress_model
...
def compress(args):
    ...
    model, search_results, rank_sum, total_rank = rank_search(model, tokenizer, args)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--decompose_method',
        type=str,
        default='svd_whiten_fisher_aware',
        choices=['whiten', 'svd', 'svd_cal'],
