...
from palu.rank_search_new import allocate_rank_from_group_rows_and_fisher, convert_group_to_rows_to_layername, convert_selection_result_to_layername
...
def compress(args):
    ...
    K_dict = get_per_layer_group_to_rows(K_list, compute_similiarity, 0.7)
    del K_list, V_list
    print(K_dict)
    ...
    compress_model(model, tokenizer, args, args.device, select_result, K_dict)
