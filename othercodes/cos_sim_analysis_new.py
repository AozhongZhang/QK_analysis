...
plt.savefig(f"/home/azzhang/streaming-llm/cos_sim_new/layer_llama3.png")

# print(len(Q_list))
# QQ, KK, QK = build_true_cosine_matrices(Q_list, K_list)
# plot_true_cosine_heatmaps(QQ, KK, QK)
